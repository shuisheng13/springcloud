...
public interface LauncThemeClassificationV2Service {
     ...
     **/
    ResponseEntity<ResultData> addthemeClass(String themeClassName, MultipartFile coverImage, long formatId);
     ...
     * @return
     **/
    ResponseEntity<ResultData> seThemeClassList(String shelfStatus,String classificationName,int pageNum,int pageSizet,Long formatId);
     ...
     * @return
     **/
    ResponseEntity<ResultData> themeClassByTid(Long formatId);
