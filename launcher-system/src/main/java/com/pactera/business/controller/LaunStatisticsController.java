...
public class LaunStatisticsController {
	...
	@ApiOperation("查询渠道列表")
	public ResponseEntity<ResultData> findChannelList() {
		PageInfo<LaunChannel> pageInfo = launStatisticsService.findChannelList();
	...
	public ResponseEntity<ResultData> selectCarStatistics(Long startTime, Long endTime, Long type, Long version,
			Long channel) {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "startTime", value = "开始时间"),
			@ApiImplicitParam(name = "endTime", value = "结束时间"),
			@ApiImplicitParam(name = "type", value = "类型(0:新增车辆1:活跃车辆2:启动次数3:升级车辆4:累计车辆)"),
			@ApiImplicitParam(name = "versions", value = "版本"), @ApiImplicitParam(name = "pageNum", value = "第几页"),
	...
	public ResponseEntity<ResultData> versionStatistics(Long startTime, Long endTime, Long type, String versions,
		...
		Map<String, Object> map = launStatisticsService.versionStatistics(startTime, endTime, pageNum, pageSize, type,
				versions);
