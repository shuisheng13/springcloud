...
public enum ErrorStatus {
	...
	SERVICE_ERROR_CAROUSEL_IMAGES_NUM(140020,"轮播图文件数量错误"),
	SERVICE_ERROR_CAROUSEL_NAME_NUM(140021,"轮播图名字超过8个字符"),
	SERVICE_ERROR_CAROUSEL_NAME_SAME(140022,"已经存在此轮播图的名字"),

	LOCALHOSTIP_EXCEPTION(140023,"获取启动服务的ip异常"),
	TOKEN_ERROR_EXP(140024,"token过期"),
	TOKEN_ERROR_FAIL(140025,"token无效"),
	TOKEN_ERROR_NULL(140025,"token不为空");
	;
